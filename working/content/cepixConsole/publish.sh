...
cp ./app/cepixConsole.App/bin/Release/net8.0/win-x64/publish/appsettings.json "${ReleaseWinPath}/appsettings.json"
cp ./app/cepixConsole.App/bin/Release/net8.0/linux-x64/publish/cepixConsole.App "${ReleaseLinuxPath}/cepixConsole"
cp ./app/cepixConsole.App/bin/Release/net8.0/linux-x64/publish/appsettings.json "${ReleaseLinuxPath}/appsettings.json"
